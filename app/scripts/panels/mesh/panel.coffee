class MeshPanel
    ...
    setPosition: (position) ->
        ...
        this.panel.find("#position-x input").val position.x.toFixed 2
        this.panel.find("#position-y input").val position.y.toFixed 2
        this.panel.find("#position-z input").val position.z.toFixed 2

    getPositionX: ->
    setPositionX: (x) ->

        this.panel.find("#position-x input").val x.toFixed 2

    getPositionY: ->
    setPositionY: (y) ->

        this.panel.find("#position-y input").val y.toFixed 2

    getPositionZ: ->
    setPositionZ: (z) ->

        this.panel.find("#position-z input").val z.toFixed 2

addMeshPanel = (mesh, coordinates = null) ->

    $("body").append "<div id='mesh' class='panel " + mesh.uuid + "'><img title='Close' class='close' src='/app/imgs/panels/nav/close/black.png'></div>"
    ...
    if geometriesWithProperties.includes(mesh.class) or geometriesWithProperties.includes(mesh.class.split("-")[1])
        ...
        panel.append "<div id='properties' class='controls'><div class='head'><img title='Fold Properties' class='fold' src='/app/imgs/panels/nav/fold/black.png'><h4>Properties</h4></div><div class='body'></div></div>"

    panel.append "<div id='position' class='controls'><div class='head'><img title='Fold Position' class='fold' src='/app/imgs/panels/nav/fold/black.png'><h4>Position</h4></div><div class='body'></div></div>"
    panel.append "<div id='rotation' class='controls'><div class='head'><img title='Fold Rotation' class='fold' src='/app/imgs/panels/nav/fold/black.png'><h4>Rotation</h4></div><div class='body'></div></div>"
    panel.append "<div id='scale' class='controls'><div class='head'><img title='Fold Scale' class='fold' src='/app/imgs/panels/nav/fold/black.png'><h4>Scale</h4></div><div class='body'></div></div>"
